...
import com.adima.service.MailService;
...
public class MailServiceImpl implements MailService {
	...
	private MimeMessagePreparator getMessagePreparator(String subject, String body, String[] to, String[] ccList,
			File[] files) {
		MimeMessagePreparator preparator = new MimeMessagePreparator() {
			public void prepare(MimeMessage message) throws Exception {
				...
				if (to != null && to.length > 0) {
					...
					LOGGER.severe(
							"La liste des destinataire est null ou vide , merci de renseigner un ou plusieurs destinataires");
					return;
				}
